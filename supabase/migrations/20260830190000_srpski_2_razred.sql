-- Srpski jezik za 2. razred, prema programu iz Prosvetnog glasnika 16/2018.
insert into public.topics (slug, name, sort_order, subject, grade) values
  ('srpski-vrste-reci-2', 'Vrste reči', 80, 'srpski', 2),
  ('srpski-gramatika-2', 'Gramatika', 90, 'srpski', 2),
  ('srpski-citanje-2', 'Čitanje i razumevanje', 100, 'srpski', 2),
  ('srpski-recnik-2', 'Rečnik', 110, 'srpski', 2),
  ('srpski-pravopis-2', 'Pravopis', 120, 'srpski', 2),
  ('srpski-knjizevnost-2', 'Književnost', 130, 'srpski', 2),
  ('srpski-jezicka-kultura-2', 'Jezička kultura', 140, 'srpski', 2);
