...
export const NAZIVI_GENERISANIH_OBLASTI: Record<string, string> = {
  ...
  'srpski-vrste-reci-2': 'Vrste reči', 'srpski-gramatika-2': 'Gramatika', 'srpski-pravopis-2': 'Pravopis',
  'srpski-citanje-2': 'Čitanje i razumevanje', 'srpski-recnik-2': 'Rečnik',
...
export const IKONE_GENERISANIH_OBLASTI: Record<string, string> = {
  ...
  'srpski-vrste-reci-2': '🔤', 'srpski-gramatika-2': '📚', 'srpski-pravopis-2': '✍️',
  'srpski-citanje-2': '📖', 'srpski-recnik-2': '🗣️',
