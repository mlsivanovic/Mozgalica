...
const PRICE: Prica[] = [
  ...
  { id: 'nikola-bicikl', tekst: 'Nikola je hteo da vozi bicikl, ali je guma bila potpuno ispumpana. U dvorištu mu je tata iz garaže doneo ručnu pumpu i pomogao mu da je napumpa. Nikola se zahvalio tati i srećan krenuo na vožnju.', ko: 'Nikola', gde: 'u dvorištu', predmet: 'ručnu pumpu iz garaže', radnja: 'napumpao je gumu na biciklu uz tatinu pomoć', razlog: 'guma na biciklu je bila potpuno ispumpana', ishod: 'srećan je krenuo na vožnju biciklom', naslov: 'Ispumpana guma' },
  ...
  // Nove priče (treći talas)
  { id: 'nemanja-akvarijum', tekst: 'Nemanja je za rođendan dobio akvarijum sa zlatnom ribicom. U enciklopediji je pročitao da ribice treba hraniti posebnom hranom i samo malo svako jutro. Izmerio je pravu količinu pahuljica, pa je ribica bila živahna i zdrava.', ko: 'Nemanja', gde: 'kod kuće pored akvarijuma', predmet: 'posebnu hranu za ribice', radnja: 'svako jutro je izmerio pravu količinu hrane', razlog: 'u enciklopediji je pročitao kako se brine o ribicama', ishod: 'ribica je bila živahna i zdrava', naslov: 'Nemanjina zlatna ribica' },
  { id: 'tea-neveni', tekst: 'Tea je sa bakom posadila seme nevena u saksije pored prozora. Svako jutro je pipnula zemlju i, kada je bila suva, pažljivo zalivala. Posle dve nedelje pojavili su se zeleni izdanci, a Tea je datum zapisala u svesku.', ko: 'Tea', gde: 'kod kuće pored prozora', predmet: 'seme nevena i saksije', radnja: 'posadila je seme i zalivala saksije dok se zemlja nije osušila', razlog: 'želela je da iz semena izraste cveće', ishod: 'posle dve nedelje pojavili su se zeleni izdanci', naslov: 'Neveni pored prozora' },
  { id: 'boris-slagalica', tekst: 'Boris je za kišnog popodneva seo da složi slagalicu sa slikom dvorca. Kad je ostalo samo nebo, nedostajala su mu tri dela. Pogledao je ispod tepiha i iza fotelje, tamo ih je i našao. Slagalicu je završio pre večere i ponosno je pokazao porodici.', ko: 'Boris', gde: 'u sobi za kišnog popodneva', predmet: 'slagalicu sa slikom dvorca', radnja: 'pretražio je sobu i pronašao tri dela slagalice', razlog: 'nedostajala su mu tri dela slagalice', ishod: 'završio je slagalicu i pokazao je porodici', naslov: 'Poslednja tri dela' },
  { id: 'mila-kucica', tekst: 'Mila je na času tehnike pravila drvenu kućicu za ptice. Otac joj je isekao daske, a Mila ih je brusila, lepila i ofarbala u plavo. Kućica je okačena na visokom stablu pred školom, a u proleće su se u nju uselili vrapci.', ko: 'Mila', gde: 'u školi na času tehnike', predmet: 'drvene daske za kućicu', radnja: 'izbrusila, izlepila i ofarbala kućicu za ptice', razlog: 'želela je da napravi dom za ptice', ishod: 'u proleće su se vrapci uselili u kućicu', naslov: 'Kućica za ptice' },
  { id: 'nadja-predstava', tekst: 'Nadja je za školsku predstavu učila ulogu vilenjače. Na samoj probi je zaboravila repliku, pa je zamolila učiteljicu da vežbaju zajedno. Vežbale su svaki odmor cele nedelje i predstava je prošla bez greške, a publika je dugo pljeskala.', ko: 'Nadja', gde: 'u školi', predmet: 'ulogu vilenjače u predstavi', radnja: 'vežbala je replike sa učiteljicom svaki odmor', razlog: 'zaboravila je repliku na probi', ishod: 'predstava je prošla bez greške', naslov: 'Uloga vilenjače' },
]
